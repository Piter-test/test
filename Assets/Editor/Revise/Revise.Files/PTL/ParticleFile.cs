    ...
    public class ParticleFile : FileLoader {
        ...
        public override void Load(Stream stream) {
            ...
            for (int i = 0; i < sequenceCount; i++) {
                ...
                sequence.DestinationBlendMode = reader.ReadInt32();//(Blend)reader.ReadInt32();
                sequence.SourceBlendMode = reader.ReadInt32();//(Blend)reader.ReadInt32();
                sequence.BlendOperation = reader.ReadInt32();//(BlendOperation)reader.ReadInt32();
